        ...
        const fetchProducts = async () => {
            try {
                ...
                const filtered = data.filter(
                    (product) => product.category === "curtains"
                );
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center px-6">
                    <div className="flex w-full max-w-6xl text-white items-center">
                        ...
                        <div className="flex-1 text-sm md:text-base">
                            <p className="mb-2">
                                Elevate your interiors with premium embroidered curtains.
                            </p>
                            <p>
                                Designed to add elegance, warmth, and timeless sophistication.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="flex flex-col md:flex-row-reverse items-center gap-10">
                            <div className="md:flex-1 text-center md:text-left">
                                <h2 className="text-3xl md:text-4xl uppercase tracking-wide mb-4">
                                    Featured Curtain Collection
                                </h2>
                                <p className="text-gray-700 mb-4">
                                    Hand-picked embroidered curtains crafted for refined interiors.
                                </p>
                                <p className="text-gray-700">
                                    Bringing texture, flow, and timeless luxury into your space.
                                </p>
                            </div>
                    ...
                    <section className="max-w-7xl mx-auto px-6 pb-24">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-gray-600 max-w-2xl mx-auto">
                                Premium curtain designs that elevate every interior space.
                            </p>
                        </div>
                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex-1 text-center md:text-left">
                        <h2 className="text-2xl md:text-3xl uppercase tracking-wide">
                            Transform Your Windows with Elegance
                        </h2>
                        <p className="text-gray-300 mt-2">
                            Discover curtains that redefine comfort and luxury.
                        </p>
                    </div>
